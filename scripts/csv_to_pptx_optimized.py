#!/usr/bin/env python3
"""
Optimized CSV to PPTX Converter
...
def create_pptx_from_csv_optimized(csv_file, output_file, title="CSV Data", author="Unknown", max_rows_per_slide=100):
    """
    ...
    """
    print(f"Starting optimized CSV to PPTX conversion...")
...
def main():
    parser = argparse.ArgumentParser(description='Convert CSV to PPTX format (optimized)')
    ...
    print("=== Optimized CSV to PPTX Converter ===")
    ...
    # Convert CSV to PPTX
    success = create_pptx_from_csv_optimized(
        args.csv_file,
        args.output_file,
        args.title,
        args.author,
