...
def create_doc_from_csv_optimized(csv_file, output_file, title="CSV Data", author="Unknown", chunk_size=1000):
    """
    Optimized CSV to DOC conversion with performance improvements.
