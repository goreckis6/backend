...
def csv_to_docx(csv_file_path, docx_file_path, title="CSV Data Document", author="Generated by MorphyHub", include_date=True):
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--author", default="Generated by MorphyHub", help="Author of the DOCX document.")
