...
def create_pptx_from_csv(csv_file, output_file, title="CSV Data", author="Unknown", max_rows_per_slide=50):
    """
    ...
    """
    print(f"Starting CSV to PPTX conversion...")
