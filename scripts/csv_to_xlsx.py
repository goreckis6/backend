...
def create_xlsx_from_csv(csv_file, output_file, title="CSV Data", author="Unknown"):
    ...
    try:
        ...
        with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
            ...
            # Add alternating row colors and borders to data
            ...
            for cell in summary_sheet[1]:  # Summary headers
            ...
            for cell in column_sheet[1]:  # Column info headers
                cell.font = Font(bold=True)
                cell.border = thin_border
            
            for row in column_sheet.iter_rows(min_row=2):
                for cell in row:
                    cell.border = thin_border
