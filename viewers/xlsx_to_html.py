...
''')
        ...
        for sheet_idx, sheet_name in enumerate(sheet_names):
            ...
            try:
                ...
                # Get stats
                rows, cols = df.shape
                html_parts.append('            <div class="excel-stats">\n')
                html_parts.append(f'                <div class="excel-stat-box"><div class="excel-stat-label">Rows</div><div class="excel-stat-value">{rows:,}</div></div>\n')
                html_parts.append(f'                <div class="excel-stat-box"><div class="excel-stat-label">Columns</div><div class="excel-stat-value">{cols}</div></div>\n')
                html_parts.append('            </div>\n')
